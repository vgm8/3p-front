      ...
      <div>
        ...
        <form className="tresp-create-cases">
          ...
          <div className="display-flex center-x center-y m-t-3 m-b-1">
            <button type="button" className="btn btn-secondary m-r-2">Guardar borrador</button>
            <button type="button" className="btn btn-primary m-r-2">Vista preliminar</button>
            <button type="button" className="btn btn-success m-r-2">Revisar y enviar</button>
          </div>
        </form>
      </div>
    )
